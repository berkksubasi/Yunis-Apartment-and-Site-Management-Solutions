...
export const ManageUsersScreen = () => {
  ...
  const deleteResident = async (id: string) => {
    try {
      const response = await fetch(`https://yunis-api.vercel.app/api/residents/${id}`, {
        method: 'DELETE',
      });
  ...
  const addOrUpdateResident = async () => {
    ...
    try {
      ...
      const url = editingResident
        ? `https://yunis-api.vercel.app/api/residents/${editingResident._id}`
        : 'https://yunis-api.vercel.app/api/residents/register';
